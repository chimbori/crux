...
public class ExtractorTodoTest {
  ...
  public void testEspn2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("espn2.html")));
  ...
  public void testWashingtonpost() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("washingtonpost.html")));
  ...
  public void testBoingboing() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("boingboing.html")));
  ...
  public void testReadwriteWeb() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("readwriteweb.html")));
  ...
  public void testYahooNewsEvenThoughTheyFuckedUpDeliciousWeWillTestThemAnyway() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("yahoo.html")));
  ...
  public void testLifehacker() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("lifehacker.html")));
  ...
  public void testNaturalhomemagazine() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("naturalhomemagazine.html")));
  ...
  public void testSfgate() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("sfgate.html")));
  ...
  public void testScientificdaily() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("scientificamerican.html")));
  ...
  public void testUniverseToday() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("universetoday.html")));
  ...
  public void testCNBC() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("cnbc.html")));
  ...
  public void testMsnbc() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("msnbc.html")));
  ...
  public void testTheAtlantic() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("theatlantic.html")));
  ...
  public void testGawker() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("gawker.html")));
  ...
  public void testNyt2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("nyt2.html")));
  ...
  public void testGettingVideosFromGraphVinyl() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("grapevinyl.html")));
  ...
  public void testLiveStrong() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("livestrong.html")));
  ...
  public void testLiveStrong2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("livestrong2.html")));
  ...
  public void testCracked() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("cracked.html")));
  ...
  public void testMidgetmanofsteel() throws Exception {
    //String url = "http://www.cracked.com/article_19029_6-things-social-networking-sites-need-to-stop-doing.html";
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("midgetmanofsteel.html")));
  ...
  public void testTrailsCom() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("trails.html")));
  ...
  public void testTrailsCom2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("trails2.html")));
  ...
  public void testEhow() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("ehow.html")));
  ...
  public void testGolfLink() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("golflink.html")));
  ...
  public void testNewsweek() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("newsweek.html")));
...
//                article.imageUrl);
  ...
  public void testBusinessweek() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("businessweek.html")));
  ...
  public void testNature() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("nature.html")));
