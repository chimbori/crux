...
//        assertTrue(res.text.endsWith("have beats and bevvies a-plenty. RSVP here.    "));
  ...
  public void testCNN() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("cnn.html")));
  ...
  public void testBBC() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("bbc_noscript.html")));
  ...
  public void testReuters() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("reuters.html")));
  ...
  public void testCaltonCaldwell() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("daltoncaldwell.html")));
  ...
  public void testWordpress() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wordpress.html")));
//        System.out.println("wordpress:" + res.text);
  ...
  public void testFirefox() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("golem.html")));
...
//        assertEquals("http://www.golem.de/1104/82797-9183-i.png", res.imageUrl);
  ...
  public void testYomiuri() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("yomiuri.html")));
  ...
  public void testFAZ() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("faz.html")));
//        assertTrue(res.text, res.text.startsWith("Im Gespräch: Umweltaktivist Stewart Brand"));
  ...
  public void testRian() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("rian.html")));
  ...
  public void testJetwick() throws Exception {
    // http://jetwick.com
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("jetwick.html")));
...
//        assertEquals("img/yourkit.png", res.imageUrl);
  ...
  public void testVimeo() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("vimeo.html")));
...
//        assertEquals("http://b.vimeocdn.com/ts/134/104/134104048_200.jpg", res.imageUrl);
  ...
  public void testYoutube() throws Exception {
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("youtube.html")));
//        assertTrue(res.text, res.text.startsWith("The makers of doom used remixed version of real metal songs for many"));
  ...
  public void testSpiegel() throws Exception {
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("spiegel.html")));
  ...
  public void testGithub() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("github.html")));
...
//        assertTrue(res.text, res.text.startsWith("ifesdjeen / jReadability Admin Watch Unwatch Fork Where do you want to for"));
  ...
  public void testITunes() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("itunes.html")));
  ...
  public void testTwitpic() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("twitpic.html")));
...
//        assertTrue(res.text, res.text.isEmpty());
  ...
  public void testTwitpic2() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("twitpic2.html")));
...
//        assertEquals("", res.text);
  ...
  public void testHeise() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("heise.html")));
  ...
  public void testTechcrunch() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("techcrunch.html")));
//        System.out.println("techcrunch:" + res.title);
  ...
  public void testEngadget() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("engadget.html")));
  ...
  public void testTwitterblog() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("twitter.html")));
...
//        assertEquals("http://4.bp.blogspot.com/-CmXJmr9UAbA/TZy6AsT72fI/AAAAAAAAAAs/aaF5AEzC-e4/s400/Blender_Tsunami.jpg", res.imageUrl);
  ...
  public void testTazBlog() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("taz.html")));
...
//        assertEquals("http://www.taz.de/uploads/hp_taz_img/full/antiakwprotestjapandapd.20110410-19.jpg", res.imageUrl);
  ...
  public void testFacebook() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("facebook.html")));
  ...
  public void testFacebook2() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("facebook2.html")));
  ...
  public void testBlogger() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("blogger.html")));
...
//        assertTrue(res.text, res.text.startsWith("Gavin King of Red Hat/Hibernate/Seam fame recently unveiled the top secret project that"));
  ...
  public void testNyt() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("nyt.html")));
  ...
  public void testHuffingtonpost() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("huffingtonpost.html")));
  ...
  public void testTechcrunch2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("techcrunch2.html")));
  ...
  public void testCnn2() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("cnn2.html")));
  ...
  public void testBusinessweek2() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("businessweek2.html")));
  ...
  public void testFoxnews() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("foxnews.html")));
  ...
  public void testStackoverflow() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("stackoverflow.html")));
//        assertTrue("stackoverflow:" + res.text, res.text.startsWith("Hi, Am torn between wicket and vaadin. i am starting a micro-isv"));
  ...
  public void testAolnews() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("aolnews.html")));
  ...
  public void testWallstreetjournal() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wsj.html")));
  ...
  public void testUsatoday() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("usatoday.html")));
  ...
  public void testUsatoday2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("usatoday2.html")));
  ...
  public void testEspn() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("espn.html")));
  ...
  public void testGizmodo() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("gizmodo.html")));
  ...
  public void testEngadget2() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("engadget2.html")));
...
//        assertTrue(res.text, res.text.startsWith("Streaming and downloading TV content to mobiles is nice"));
  ...
  public void testWired() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wired.html")));
  ...
  public void tetGigaohm() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("gigaom.html")));
  ...
  public void testMashable() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("mashable.html")));
  ...
  public void testVenturebeat() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("venturebeat.html")));
  ...
  public void testPolitico() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("politico.html")));
  ...
  public void testNinjablog() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("ninjatraderblog.html")));
  ...
  public void testSportsillustrated() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("sportsillustrated.html")));
  ...
  public void testDailybeast() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("thedailybeast.html")));
  ...
  public void testScience() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("sciencemag.html")));
  ...
  public void testSlamMagazine() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("slamonline.html")));
  ...
  public void testEspn3WithFlashVideo() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("espn3.html")));
  ...
  public void testSportingNews() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("sportingnews.html")));
  ...
  public void testFoxSports() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("foxsports.html")));
  ...
  public void testEconomist() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("economist.html")));
  ...
  public void testTheVacationGals() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("thevacationgals.html")));
  ...
  public void testShockYa() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("shockya.html")));
  ...
  public void testWikipedia() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia.html")));
  ...
  public void testWikipedia2() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia_president.html")));
  ...
  public void testWikipedia3() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia_muhammad.html")));
  ...
  public void testWikipedia4() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia_Henne_Strand.html")));
  ...
  public void testWikipedia5() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia_java.html")));
  ...
  public void testWikipedia6() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("wikipedia-knight_rider_de.html")));
  ...
  public void testTimemagazine() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("time.html")));
  ...
  public void testCnet() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("cnet.html")));
  ...
  public void testBloomberg() throws Exception {
    ...
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("bloomberg.html")));
  ...
  public void testTheFrisky() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("thefrisky.html")));
  ...
  public void testBrOnline() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("br-online.html")));
  ...
  public void testGaltimeWhereUrlContainsSpaces() throws Exception {
    ...
    ParsedResult article = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("galtime.com.html")));
  ...
  public void testIssue8() throws Exception {
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("no-hidden.html")));
    assertEquals("This is the text which is shorter but visible", res.text);
  }

  @Test
  public void testIssue8False() throws Exception {
    ParsedResult res = extractor.extractContent(c.streamToString(getClass().getResourceAsStream("no-hidden2.html")));
