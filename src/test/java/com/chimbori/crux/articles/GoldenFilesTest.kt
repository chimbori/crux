...
class GoldenFilesTest {
  ...
  fun testTheVacationGals() {
    ...
    assertEquals(3, article.images.size.toLong())
    assertEquals("http://thevacationgals.com/wp-content/uploads/2010/11/Gemmel-Family-Reunion-at-a-Vacation-Rental-Home1-300x225.jpg", article.images[0].src)
    assertEquals("../wp-content/uploads/2010/11/The-Gemmel-Family-Does-a-Gilligans-Island-Theme-Family-Reunion-Vacation-Sarah-Gemmel-300x225.jpg", article.images[1].src)
    assertEquals("http://www.linkwithin.com/pixel.png", article.images[2].src)
  }
